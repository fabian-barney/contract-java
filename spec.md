...
precondition failures map to HTTP `400` and generated `IllegalStateException`
postcondition failures map to HTTP `500`. Non-contract exceptions are not
handled by the starter.
