...
dependencies {
    implementation("media.barney:contract-core:0.1.9")
    annotationProcessor("media.barney:contract-core:0.1.9")
}
...
`media.barney:contract-spring-boot-starter:0.1.9` as the
