...
dependencies {
    implementation("media.barney:contract-core:0.1.7")
    annotationProcessor("media.barney:contract-core:0.1.7")
}
...
`media.barney:contract-spring-boot-starter:0.1.7` as the
